    ...
    <div className=" ">
      <nav className=" flex justify-between h-20 px-4 xl:px-0 max-w-screen-xl m-auto     ">
        ...
        >
          ...
          <Link onClick={handleShow} href="/#why-choose-us">Why Gap Immigration</Link>
          <Link onClick={handleShow} href="/#choose-your-class">Book Class</Link>
          <Link onClick={handleShow} href="/#about-us">About us</Link>
          <Link onClick={handleShow} href="/#contact-us">Contact us</Link>
          <div className="hidden lg:flex space-x-3">
            <Link href="/#choose-your-class">
